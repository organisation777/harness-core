...
import static software.wings.beans.command.ContainerSetupParams.ContainerSetupParamsKeys.containerTask;
...
public class ContainerSetupParamsTest extends CategoryTest {
  ...
  public void TestPreLoadNoThrowForContainerTaskNull() {
    ...
    paramDBObject.put(containerTask, null);
  ...
  public void TestPreLoadNoThrowForNoClassName() {
    DBObject paramDBObject = new BasicDBObject();
    paramDBObject.put(containerTask, new BasicDBObject());
  ...
  public void TestPreLoadNoThrowForClassNameNull() {
    ...
    DBObject paramDBObject = new BasicDBObject();
    paramDBObject.put(containerTask, containerTaskDBObject);
  ...
  public void TestPreLoadNoChangesForUnknownClassName() {
    ...
    assertThat(((DBObject) paramDBObject.get(containerTask)).get(MORPHIA_CLASS_NAME_FIELD)).isEqualTo(initialClassName);
  }
  ...
  public void TestPreLoadChangesClassNameForK8sOriginal() {
    ...
    assertThat(((DBObject) paramDBObject.get(containerTask)).get(MORPHIA_CLASS_NAME_FIELD))
